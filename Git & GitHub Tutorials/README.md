...
2. Clone the repository on your local machine 
    ...
    - In GitHub desktop - Repository -> Repository settings... -> Fork behaviour -> select To contribute to the parent repository
...
4. Create a branch 
    - You should create a branch for each **3 tasks**.
...
5. Commit a solution to a task
    - Commit the file for the task.
    - **Each task should be in a separate commit.**
    - Repeat steps 5. and 6. until you have 3 tasks in the new branch. <br />
